    ...
    <>
      <Box sx={{ color: "white", marginTop: "6ch" }}>
        <Container maxWidth="lg">
          ...
          >
            <Typography
              variant="h3"
              sx={{ fontWeight: "bold", fontSize: { xs: "30px", lg: "40px" } }}
            >
              Insights
            </Typography>
            <Typography
              variant="body1"
              sx={{ marginTop: "1ch", fontSize: "18px" }}
            >
          ...
          >
            ...
            <Box sx={{ width: { xs: "80%", lg: "50%" } }}>
              <Typography
                sx={{
                  width: { xs: "80px", md: "", lg: "5vw" },
      ...
      <Box sx={{ minHeight: "50vh", color: "white", marginTop: "6ch" }}>
        <Container maxWidth="lg">
          ...
          >
            <Box
              sx={{ width: { xs: "100%", lg: "20%" }, position: "relative" }}
            >
              <Box
                sx={{
                  position: "sticky",
              ...
              >
                <Typography variant="body2" sx={{ fontWeight: "bold" }}>
                  BLOCKCHAIN DAO DEFI GAMING GUIDES NFT SMART MONEY
                </Typography>
              </Box>
            </Box>
